...
function page(trail) {
  ...
  const image = 'https://www.5terrego.com/seo.png';
  const structured = JSON.stringify({ '@context': 'https://schema.org', '@graph': [
    { '@type': 'WebPage', '@id': canonical, name: trail.name, description: trail.description || '', url: canonical, isPartOf: { '@type': 'WebSite', name: '5TerreGo', url: 'https://www.5terrego.com/' }, primaryImageOfPage: { '@id': `${canonical}#image` }, about: { '@type': 'Thing', name: trail.name } },
    { '@type': 'ImageObject', '@id': `${canonical}#image`, contentUrl: image, url: image, caption: `Mappa e percorso del sentiero ${trail.name} nelle Cinque Terre`, representativeOfPage: true },
    { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Sentieri', item: 'https://www.5terrego.com/sentieri.html' }, { '@type': 'ListItem', position: 2, name: trail.name, item: canonical }] }
  ] }).replace(/</g, '\\u003c');
  return `<!doctype html><html lang="it"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><title>${title} | Sentieri Cinque Terre | 5TerreGo</title><meta name="description" content="${description.slice(0, 158)}"><link rel="canonical" href="${canonical}"><meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"><meta property="og:type" content="article"><meta property="og:site_name" content="5TerreGo"><meta property="og:locale" content="it_IT"><meta property="og:title" content="${title}"><meta property="og:description" content="${description.slice(0, 180)}"><meta property="og:url" content="${canonical}"><meta property="og:image" content="${image}"><meta property="og:image:alt" content="Mappa e percorso del sentiero ${title} nelle Cinque Terre"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="${title}"><meta name="twitter:description" content="${description.slice(0, 180)}"><meta name="twitter:image" content="${image}"><meta name="theme-color" content="${accent}"><link rel="icon" href="/app.png"><script type="application/ld+json">${structured}</script><style>
...
sitemap = sitemap.replace('</urlset>', `  <url><loc>https://www.5terrego.com/trails/</loc></url>\n${entries}\n</urlset>`).replace(/\n{3,}/g, '\n\n');
