...
function relatedMarkup(post) {
  const cards = relatedStories(post).map((related) => {
    const href = `/stories/${encodeURIComponent(related.slug)}.html`;
    const image = escapeHTML(related.cover_image || 'https://www.5terrego.com/seo.png');
    return `<a class="related-card" href="${href}"><img src="${image}" alt="${escapeHTML(related.title)}" loading="lazy"><span class="related-copy"><small>${escapeHTML(label(related.category || 'Guide'))}</small><strong>${escapeHTML(related.title)}</strong><span>${readingMinutes(related)} min read →</span></span></a>`;
  }).join('');
  return `<section class="related" aria-labelledby="related-title"><div class="related-head"><div><p>Continue reading</p><h2 id="related-title">Related stories</h2></div><span>Swipe to explore →</span></div><div class="related-track">${cards}</div></section>`;
}
...
<style>
:root{--ink:#122033;--muted:#66758a;--paper:#f6f2e9;--sea:#0d5960;--orange:#ff6b00;--line:#dfd8ca}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--paper);color:var(--ink);font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.top{height:76px;display:flex;align-items:center;justify-content:space-between;padding:0 max(22px,calc((100vw - 1180px)/2));border-bottom:1px solid var(--line);background:rgba(246,242,233,.94);position:sticky;top:0;z-index:5;backdrop-filter:blur(14px)}.logo{font-size:24px;font-weight:950;letter-spacing:-.06em;color:var(--ink);text-decoration:none}.logo b{color:var(--orange)}.back{color:var(--ink);font-weight:800;text-decoration:none}.hero{max-width:1180px;margin:34px auto 0;padding:0 24px;display:grid;grid-template-columns:minmax(0,1.05fr) minmax(340px,.95fr);gap:42px;align-items:center}.cover{width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:32px;box-shadow:0 28px 70px rgba(23,35,51,.14)}.kicker{margin:0 0 15px;color:var(--orange);font-size:13px;font-weight:900;letter-spacing:.15em;text-transform:uppercase}.hero h1{font-family:Georgia,"Times New Roman",serif;font-size:clamp(42px,5.4vw,76px);line-height:.94;letter-spacing:-.055em;margin:0}.dek{font-size:19px;line-height:1.55;color:var(--muted);margin:24px 0 0}.meta{display:flex;gap:12px;flex-wrap:wrap;margin-top:22px;font-size:13px;font-weight:800;color:var(--sea)}.article{width:min(760px,calc(100% - 40px));margin:58px auto 50px;font-family:Georgia,"Times New Roman",serif;font-size:20px;line-height:1.78}.article p{margin:0 0 26px}.article h2{font-family:Inter,-apple-system,sans-serif;font-size:34px;line-height:1.08;letter-spacing:-.04em;margin:54px 0 18px}.article h3{font-family:Inter,-apple-system,sans-serif;font-size:25px;margin:38px 0 14px}.article ul{padding-left:24px}.article li{margin:10px 0}.article a{color:var(--sea);text-underline-offset:3px;overflow-wrap:anywhere}.related{max-width:1180px;margin:0 auto 90px;padding:36px 24px 12px;border-top:1px solid var(--line)}.related-head{display:flex;align-items:end;justify-content:space-between;gap:24px;margin-bottom:22px}.related-head p{margin:0 0 7px;color:var(--orange);font-size:11px;font-weight:950;letter-spacing:.14em;text-transform:uppercase}.related-head h2{margin:0;font-family:Georgia,"Times New Roman",serif;font-size:38px;letter-spacing:-.045em}.related-head>span{color:var(--muted);font-size:13px;font-weight:800}.related-track{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(260px,31%);gap:18px;overflow-x:auto;scroll-snap-type:x mandatory;padding:2px 2px 18px;scrollbar-width:thin}.related-card{scroll-snap-align:start;display:flex;flex-direction:column;min-height:100%;background:#fff;border:1px solid var(--line);border-radius:22px;overflow:hidden;color:var(--ink);text-decoration:none;transition:transform .18s ease,box-shadow .18s ease}.related-card:hover{transform:translateY(-4px);box-shadow:0 18px 42px rgba(18,32,51,.1)}.related-card img{width:100%;aspect-ratio:16/10;object-fit:cover}.related-copy{display:flex;flex-direction:column;align-items:flex-start;padding:16px 17px 18px;flex:1}.related-copy small{color:var(--orange);font-size:10px;font-weight:950;letter-spacing:.12em;text-transform:uppercase}.related-copy strong{font-family:Georgia,"Times New Roman",serif;font-size:22px;line-height:1.03;margin:10px 0 18px}.related-copy>span{margin-top:auto;color:var(--sea);font-size:12px;font-weight:850}.end{padding-top:16px;margin-top:36px;font-family:Inter,-apple-system,sans-serif}.end a{display:inline-flex;padding:13px 18px;border-radius:999px;background:var(--ink);color:white;text-decoration:none;font-weight:850;font-size:14px}@media(max-width:760px){.top{height:64px}.hero{grid-template-columns:1fr;gap:25px;margin-top:18px;padding:0 16px}.cover{border-radius:24px}.hero-copy{order:2}.hero h1{font-size:clamp(38px,12vw,57px)}.dek{font-size:17px}.article{margin-top:44px;font-size:18px}.article h2{font-size:29px}.related{padding:28px 16px 6px;margin-bottom:60px}.related-head h2{font-size:31px}.related-head>span{display:none}.related-track{grid-auto-columns:minmax(245px,82%)}}
</style></head><body>
