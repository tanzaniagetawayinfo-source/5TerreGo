...
(function () {
  ...
  function ensureGlobalActionbarStyle() {
    ...
    style.textContent = [
      ...
      '#ai-mascot-video{width:92%;height:92%;object-fit:contain;object-position:center top;display:block;pointer-events:none;transform:translateY(-6px);}',
  ...
  window.addEventListener('load', function () {
    ...
    aiButton = ensureCaptainGullButton();
    console.assert(Boolean(aiButton && document.getElementById(GLOBAL_AI_BUTTON_ID)), 'FTG global actionbar: Captain Gull AI button exists');
  });
}());
